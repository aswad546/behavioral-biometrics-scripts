...
, function(k, t, e) {
    ...
    function n() {
        ...
        function u(t, e, n, i) {
            var r, o, a, u, e = e && e.prototype instanceof _ ? e : _, e = D(e.prototype), i = new T(i || []);
            return l(e, "_invoke", {
                value: (r = t,
                o = n,
                a = i,
...
, function(q, t, e) {
    ...
    function Z(t, e, n, i) {
        ...
        tt || (r += " domain=".concat(i, ";")),
        document.cookie = r
    }
    var tt = !!window.MSInputMethodContext && !!document.documentMode;
    function et(t) {
    ...
    function ve(e) {
        for (var t = 1; t < arguments.length; t++) {
            ...
            t % 2 ? pe(Object(n), !0).forEach(function(t) {
                a()(e, t, n[t])
            }) : h.a ? Object.defineProperties(e, h()(n)) : pe(Object(n)).forEach(function(t) {
    ...
    function _e(t, e, n, i, r, o, a, u, s, c, l, f, d, h, p, v, g, _, y, m, w, E, b, S) {
        return {
            type: t,
            f: e,
            cid: n,
    ...
    function Re(t) {
        return i.a.matchesSelector(t, "select") ? Le(t) : i.a.matchesSelector(t, "[type=checkbox],[type=radio]") ? qe(t) : "S~C~~" + (t.value || "").length
    }
    function Le(t) {
    ...
    var E, b, je, Ue = /live/, Fe = function() {
        return n()(function t(e) {
            ...
            value: function(t) {
                var e, n;
                w(t.target) || o.matchesSelector(t.target, "input[type=checkbox],input[type=radio],select") || (n = Pe(this._targetValues[t.target._nid_id] || "", e = t.target.value),
                ...
                this._queue.enqueue(xe(t.target, n)))
            }
        }, {
            key: "radioChange",
            value: function(t) {
                ...
                this._queue.enqueue(Te(t.target, e)))
            }
        }, {
            key: "checkboxChange",
            value: function(t) {
            ...
            value: function(t) {
                var e;
                w(t.target) || o.matchesSelector(t.target, "select") && (e = Le(t.target),
                k("SELECT_CHANGE - ".concat(t.target.targetSelector, " - ").concat(e), "change"),
                this._queue.enqueue(Ie(t.target, e)))
            }
        }, {
            key: "registerTarget",
            value: function(t) {
            ...
            value: function() {
                var e = this;
                !Ue.test(this._api._key) && this._api._eventPropagationOverride && (Event.prototype.stopPropagation = function() {
                    var t;
            ...
            value: function() {
                !Ue.test(this._api._key) && this._api._eventPropagationOverride && (Event.prototype.stopPropagation = this._originalEventPropagation)
            }
        }, {
            key: "start",
            value: function() {
        ...
        return n()(function t(e) {
            ...
            value: function(t) {
                ...
                this._queue.enqueue(Ee(t.target, e)))
            }
        }, {
            key: "keyup",
            value: function(t) {
            ...
            value: function(t) {
                ...
                this._queue.enqueue(ke(t.target, e, n, t))
            }
        }, {
            key: "mousemove",
            value: function(t) {
            ...
            value: function(t) {
                ...
                this._queue.enqueue(ye(t.target)),
                this._queue.flush()
            }
        }, {
            key: "focusout",
            ...
            value: function(t) {
                ...
                n = Pe(this._targetValues[t.target._nid_id] || "", e = t.target.value),
                this._targetValues[t.target._nid_id] = e,
                n.hash = this._api._generateAndTruncateSaltedHash(e),
                this._queue.enqueue(we(t.target, n)))
            }
        }, {
            key: "invalid",
            value: function(t) {
    ...
    }(), t = e(46), Ve = e.n(t), t = e(34), Ge = e.n(t), t = e(47), He = e.n(t), ze = He.a.mark(un);
    function Ke(t, e) {
        ...
        if (Array.isArray(t) || (a = function(t, e) {
            var n;
            if (t)
                return "string" == typeof t ? Qe(t, e) : "Map" === (n = "Object" === (n = Object.prototype.toString.call(t).slice(8, -1)) && t.constructor ? t.constructor.name : n) || "Set" === n ? u()(t) : "Arguments" === n || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n) ? Qe(t, e) : void 0
    ...
    function Xe(t, e) {
        ...
        e = b.root,
        n = n,
        je = e.nodeType === Node.DOCUMENT_NODE || e !== n.root ? e : e.ownerDocument,
        (n = Ye(t, E.All, function() {
            return Ye(t, E.Two, function() {
                return Ye(t, E.One)
            })
        })) ? Je(n = 0 < (e = an(un(n, t))).length ? e[0] : n) : null)
    }
    function Ye(t, o, a) {
        for (var u = null, s = [], c = t, l = 0, e = function() {
            var t, e, n = rn(function(t) {
                t = t.getAttribute("id");
                if (t)
                    return {
                        name: "#" + Ve()(t, {
                ...
                n !== t); )
                    n = n.nextSibling;
                return i
            }(c), r = (o === E.All ? i && (n = n.concat(n.filter(nn).map(function(t) {
                return en(t, i)
            }))) : o === E.Two ? (n = n.slice(0, 1),
            i && (n = n.concat(n.filter(nn).map(function(t) {
                return en(t, i)
            ...
            if (s.push(n),
            s.length >= b.seedMinLength && (u = $e(s, a)))
                return 1;
            c = c.parentElement,
            l++
    ...
    function tn(t) {
        switch (je.querySelectorAll(Je(t)).length) {
        case 0:
            return;
        case 1:
            return 1;
        ...
        return He.a.wrap(function(t) {
            for (; ; )
                ...
                case 2:
                    ...
                    break;
                case 8:
                    return t.delegateYield(un(a, r), "t0", 9);
                case 9:
                    o++,
                    t.next = 2;
                    break;
    ...
    var t = e(117)
      ...
      , cn = function() {
        return n()(function t(e) {
            ...
            value: function(n) {
                var i = this;
                sn()(this._componentBinders).forEach(function(t) {
                    var t = Ge()(t, 2)
                      , e = t[0]
                      , t = t[1];
    ...
    var hn = {
      ...
      , xn = function() {
        return n()(function t() {
            ...
            key: "isAlphanumeric",
            value: function(t) {
                return pn <= t && t <= vn || (gn <= t && t <= _n || yn <= t && t <= mn) || (wn <= t && t <= En || bn <= t && t <= Sn)
            }
        }, {
            key: "getKeyCode",
            value: function(t) {
            ...
            value: function(e) {
                ...
                return g()(hn).forEach(function(t) {
                    n[t] = e[hn[t]]
                }),
                n
            }
            ...
            value: function(t) {
                var e;
                "KEY_DOWN" == t.type && 0 <= I(In, this).indexOf(c()(t.kc)) || null != I(x, this)[0] && "KEY_DOWN" == t.type && I(In, this).indexOf(0 <= c()(I(x, this)[0].kc)) ? I(x, this).push(t) : (t = this,
                e = [],
                x.set(dn(x, t), e))
            }
        }])
    ...
    function Tn(t, e) {
        ...
        if (Array.isArray(t) || (a = function(t, e) {
            var n;
            if (t)
                return "string" == typeof t ? On(t, e) : "Map" === (n = "Object" === (n = Object.prototype.toString.call(t).slice(8, -1)) && t.constructor ? t.constructor.name : n) || "Set" === n ? u()(t) : "Arguments" === n || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n) ? On(t, e) : void 0
        }(t)) || e && t && "number" == typeof t.length)
            return a && (t = a),
            o = 0,
            {
    ...
    function Nn(e) {
        for (var t = 1; t < arguments.length; t++) {
            ...
            t % 2 ? Cn(Object(n), !0).forEach(function(t) {
                a()(e, t, n[t])
            }) : h.a ? Object.defineProperties(e, h()(n)) : Cn(Object(n)).forEach(function(t) {
                Object.defineProperty(e, t, d()(n, t))
            })
        }
        return e
    ...
    function jn() {
        return qn() && void 0 !== navigator.brave
    }
    function Un() {
    ...
    function Fn() {
        return Ln() ? Ln() && navigator._duckduckgoloader_ ? "DuckDuckGo" : 0 <= navigator.userAgent.indexOf("CriOS") ? "Chrome" : "Safari" : qn() ? Un() : Mn() ? "FireFox" : Pn() ? "MSIE" : jn() ? "Brave" : "Unknown"
    }
    function Bn() {
    ...
    function Wn() {
        ...
        return e = (e = (e = (e = (e = e.concat(function() {
            ...
            /headless/i.test(e.value) && t.push(ce);
            /electron/i.test(e.value) && t.push(te);
            /slimerjs/i.test(e.value) && t.push(ue);
            return t
        }())).concat((n = [],
        t = {},
        a()(a()(a()(a()(a()(a()(a()(a()(a()(a()(t, ce, ["domAutomation", "domAutomationController"]), re, ["callPhantom", "_phantom", "phantom"]), p, ["webdriver", "__webdriverFunc", "__lastWatirAlert", "__lastWatirConfirm", "__lastWatirPrompt", "_WEBDRIVER_ELEM_CACHE", "ChromeDriverw"]), se, ["wdioElectron"]), ae, ["_Selenium_IDE_Recorder", "_selenium", "calledSelenium", "callSelenium"]), $t, ["awesomium"]), Jt, ["RunPerfTest"]), Zt, ["CefSharp"]), ee, ["fmget_targets"]), ne, ["geb"]),
        i = a()(a()(t, ie, ["__nightmare", "nightmare"]), oe, ["spawn"]),
        ...
        n))).concat((r = [],
        o = a()(a()({}, ae, ["__selenium_evaluate", "selenium-evaluate", "__selenium_unwrapped"]), p, ["__webdriver_script_fn", "__driver_evaluate", "__webdriver_evaluate", "__fxdriver_evaluate", "__driver_unwrapped", "__webdriver_unwrapped", "__fxdriver_unwrapped", "__webdriver_script_fn", "__webdriver_script_func", "__webdriver_script_function", "$cdc_asdjflasutopfhvcZLmcf", "$cdc_asdjflasutopfhvcZLmcfl_", "$chrome_asyncScriptInfo", "__$webdriverAsyncExecutor"]),
        ...
        r))).concat(function() {
            var t = []
              , e = Bn();
            /PhantomJS/i.test(e) && t.push(re);
            /Headless/i.test(e) && t.push(ce);
            /Electron/i.test(e) && t.push(te);
            /slimerjs/i.test(e) && t.push(ue);
            return t
    ...
    e = {},
    a()(a()(a()(a()(a()(a()(a()(a()(a()(a()(e, st, function() {
    ...
    a()(a()(a()(a()(a()(a()(a()(a()(a()(a()(e, Et, function() {
    ...
    a()(a()(a()(a()(a()(a()(a()(a()(a()(a()(e, kt, function() {
        ...
        return "Opera" === Un() ? 0 : window.devicePixelRatio
    }), Vt, function() {
        var i = []
    ...
    var Hn = a()(a()(a()(a()(e, "math", function() {
        var t = Math;
        ...
        return Mn() ? 0 : "".concat(window.doNotTrack).concat(window.navigator.doNotTrack).concat(window.navigator.msDoNotTrack)
    }), Kt, function() {
    ...
    function Xn() {
        return new O.a(function(e, n) {
            try {
                var t;
                (void 0 !== (null == (t = self) || null == (t = t.Promise) ? void 0 : t.allSettled) ? Qn().then(function(t) {
                    e(t)
    ...
    function Yn() {
        return Ln() ? Kn() : qn() && !jn() ? Xn() : Mn() ? new O.a(function(t, e) {
            try {
                var n;
    ...
    function Zn(e) {
        for (var t = 1; t < arguments.length; t++) {
            ...
            t % 2 ? Jn(Object(n), !0).forEach(function(t) {
                a()(e, t, n[t])
            }) : h.a ? Object.defineProperties(e, h()(n)) : Jn(Object(n)).forEach(function(t) {
                Object.defineProperty(e, t, d()(n, t))
            })
        }
        return e
    ...
    var ti = function() {
        return n()(function t() {
            ...
            value: function() {
                var r = this;
                return new O.a(function(e, n) {
                    var i = r._fpSignals || zn();
                    $n().then(function(t) {
                        t = r._generateDeviceId(Zn(Zn({}, i), {}, a()({}, v, t)));
                        e(t)
                    }).catch(function(t) {
                        n(t)
                    })
            ...
            value: function() {
                ...
                return new O.a(function(i, e) {
                    try {
                        ...
                        ), Yn(), $n(), n.getDeviceId(), new O.a(function(e) {
                            var t, n;
                        ...
                        O.a.allSettled(t).then(function(t) {
                            var e, n = Zn(Zn({}, r), {}, (e = {},
                            a()(a()(a()(a()(a()(a()(a()(a()(a()(a()(e, qt, "fulfilled" === t[0].status && t[0].value), Pt, Wn()), jt, "fulfilled" === t[1].status && t[1].value), bt, Fn()), Ut, Bn()), Ft, navigator.userAgentData || {}), v, "fulfilled" === t[2].status ? t[2].value : null), zt, "fulfilled" === t[3].status ? t[3].value : null), pt, null == (n = screen) ? void 0 : n.isExtended), ft, {
                                width: screen.width,
                                height: screen.height
                            }),
                            a()(a()(a()(a()(e, dt, null == (n = screen) ? void 0 : n.colorDepth), ht, null == (e = screen) ? void 0 : e.pixelDepth), Xt, "fulfilled" === t[4].status ? t[4].value : []), Yt, he())));
                            i(n)
                        })
                    } catch (t) {
                        e(t)
    ...
    var ri = "Blocked by CSP"
      , oi = "The endpoint parameter is not a valid URL"
      , t = D("WrongRegion")
      , e = D("SubscriptionNotActive")
      , ai = D("UnsupportedVersion")
      , ui = D("InstallationMethodRestricted")
      , si = "API key required"
      , R = "API key not found"
      , ci = "API key expired"
      , li = "Failed to load the JS script of the agent"
      , fi = "9319";
    function di(t, i) {
        var r, o, a, e, n, u, s = [], t = (n = ii([], t, !0),
        r = {
            current: function() {
                return n[0]
            },
        ...
        [r.current(), function(t, e) {
            var n, i, e = e instanceof Error ? e.message : "", e = (e === ri || e === oi ? (r.exclude(),
            n = 0) : e === fi ? r.exclude() : (e === li && (e = Date.now() - t.getTime() < 50,
    ...
    var hi = "https://fpnpmcdn.net/v<version>/<apiKey>/loader_v<loaderVersion>.js";
    function pi(t) {
        return i = t,
        e = document,
    ...
    var gi = {
        load: function(t) {
            ...
            var e = t.token
              , n = t.apiKey
              , r = void 0 === n ? e : n
              , i = ni(t, ["scriptUrlPattern", "token", "apiKey"])
              , o = null !== (e = t,
            n = "scriptUrlPattern",
            t = Object.prototype.hasOwnProperty.call(e, n) ? e[n] : void 0) && void 0 !== t ? t : hi
              , a = (e = function() {
                function t() {
                    o.push({
                        time: new Date,
            ...
            return Promise.resolve().then(function() {
                ...
                if (r && "string" == typeof r)
                    return t = o,
                    i = r,
                    di((Array.isArray(t) ? t : [t]).map(function(t) {
                        return t = String(t),
                        e = i,
                ...
                throw u(),
                (t = t)instanceof Error && t.message === fi ? new Error(li) : t
            }).then(function(t) {
                var e = t[0]
                  , t = t[1];
                return u(),
        ...
        ERROR_SCRIPT_LOAD_FAIL: li,
        ERROR_API_KEY_EXPIRED: ci,
        ERROR_API_KEY_INVALID: R,
        ERROR_API_KEY_MISSING: si,
        ...
        ERROR_CSP_BLOCK: ri,
        ERROR_FORBIDDEN_ENDPOINT: D("HostnameRestricted"),
        ...
        ERROR_INSTALLATION_METHOD_RESTRICTED: ui,
        ERROR_INTEGRATION_FAILURE: D("IntegrationFailed"),
        ERROR_INVALID_ENDPOINT: oi,
                ...
                return new O.a(function(n, i) {
                    try {
                        r._makeAjaxCall(function(t) {
                            ...
                            e = {
                                endpoint: [r._advancedDeviceEndpoint, gi.defaultEndpoint],
                                apiKey: t,
                                scriptUrlPattern: ["".concat(r._advancedDeviceEndpoint, "/web/v<version>/").concat(t, "/loader_v<loaderVersion>.js"), gi.defaultScriptUrlPattern]
                            },
                            n(gi.load(e))) : i(new Error("Advanced device error: No key was returned in the agent's response")) : i(new Error("Adavanced device error: Non 200 response received from agent"))
                        })
                    } catch (t) {
                        i(t)
                    }
    ...
    function yi(t, e) {
        ...
        if (Array.isArray(t) || (a = function(t, e) {
            var n;
            if (t)
                return "string" == typeof t ? mi(t, e) : "Map" === (n = "Object" === (n = Object.prototype.toString.call(t).slice(8, -1)) && t.constructor ? t.constructor.name : n) || "Set" === n ? u()(t) : "Arguments" === n || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n) ? mi(t, e) : void 0
        }(t)) || e && t && "number" == typeof t.length)
            return a && (t = a),
            o = 0,
            {
    ...
    var wi, L, Ei = ["data-nid-target", "neuro-select-question", "neuro-text-question", "neuro-region-question", "data-neuro-text-question", "data-neuro-multiple-choice-question", "data-neuro-select-question", "data-neuro-region-question", "data-neuro-answer-label", "data-neuro-label", "data-neuro-button", "data-neuro-region", "data-neuro-link"], bi = ["input", "textarea", "button", "select", "a"], Si = {
        failPattern: {
            code: 400,
        ...
        return n()(function M(t) {
            var P = this
              ...
              , N = void 0 !== N && N
              , D = t.stateChangeListenerInterval
              , D = void 0 === D ? 200 : D
              , R = t.stateChangeListener
              , R = void 0 === R ? "automatic" : R
              , L = t.autoStart
              , L = void 0 === L ? "true" : L
              , q = t.eventCapturing
              , q = void 0 !== q && q
              , B = t.eventPropagationOverride
              , B = void 0 === B || B
              , W = t.includeDevice
              , W = void 0 !== W && W
              , V = t.invokeAdvancedOnLoad
              , V = void 0 !== V && V
              , t = t.multiFlow
              , t = void 0 !== t && t;
            if (G()(this, M),
            ...
            this._stateChangeListener = R,
            this._stateChangeListenerInterval = D,
            ...
            this._binder = Ae,
            this._unbinder = Ce,
            this._eventCapturing = q,
            this._eventPropagationOverride = B,
            this._includeDevice = this._isAdvancedDeviceEnabled() || W,
            this._invokeAdvancedOnLoad = V,
            this._multiFlow = t,
            "auto" === d && window.jQuery && (this._binder = Ne,
            this._unbinder = De),
            this._keyCodeMapping = new xn,
            this._queue = new We({
                api: this,
                collectorEndpoint: i,
                requestTimeout: n,
            ...
            this._targetChangeListener = new Fe({
                api: this,
                queue: this._queue
            }),
            this._visibilityDepth = Math.min(A, 12),
            this._pageEventsListener = new Be({
                api: this,
                queue: this._queue,
                targetAll: u,
            ...
            this._componentListener = new cn({
                api: this,
                queue: this._queue
            }),
            this._deviceIdentifier = new ti,
            this._advancedDevice = this._isAdvancedDeviceEnabled() ? new _i({
                api: this,
            ...
            value: function() {
                ...
                sessionStorage.removeItem(this._saltStorageName),
                this._clientId = $(),
                this._userId = null,
                this._registeredUserId = null,
                Z(this._clientIdCookieName, this._clientId, this._cookieExpires, this._cookieDomain),
                ...
                b = t.inIframe,
                t = t.jsLibraries,
                _e("CREATE_SESSION", e, n, i, r, o, a, u, s, c, l, f, d, h, p, v, g, _, y, m, w, E, b, void 0 === t ? [] : t))),
            ...
            value: function() {
                var t, n, i = this;
                this._isAdvancedDeviceEnabled() && ((t = J(this._advancedDeviceRequestIdCookieName)) ? this._logAndSendAdvEvent(t, !0) : this._advancedDevice.getAdvancedDeviceClient().then(function(t) {
                    return n = Date.now(),
                    t.get()
                }).then(function(t) {
                    var e = Date.now() - n;
                    null != t && t.requestId && (Z(i._advancedDeviceRequestIdCookieName, t.requestId, i._advancedCookieExpires, i._cookieDomain),
            ...
            value: function() {
                ...
                this._includeDevice && this._deviceIdentifier.getDeviceData().then(function(t) {
                    ...
                    a()(a()(a()(a()(a()(a()(a()(a()(a()(a()(e, st, t[st]), lt, t[lt]), ct, t[ct]), ft, t[ft]), dt, t[dt]), ht, t[ht]), pt, t[pt]), vt, t[vt]), gt, t[gt]), _t, t[_t]),
                    a()(a()(a()(a()(a()(a()(a()(a()(a()(a()(e, yt, t[yt]), mt, t[mt]), wt, t[wt]), Et, t[Et]), St, t[St]), It, t[It]), xt, t[xt]), Tt, t[Tt]), Ct, t[Ct]), At, t[At]),
                    a()(a()(a()(a()(a()(a()(a()(a()(a()(a()(e, "hdr", t.hdr), Nt, t[Nt]), Ot, t[Ot]), kt, t[kt]), Dt, t[Dt]), Rt, t[Rt]), Lt, t[Lt]), p, t[p]), Mt, t[Mt]), Bt, t[Bt]),
                    a()(a()(a()(a()(a()(a()(a()(a()(a()(a()(e, Wt, t[Wt]), Vt, t[Vt]), Gt, t[Gt]), Ht, t[Ht]), qt, t[qt]), Pt, t[Pt]), jt, t[jt]), bt, t[bt]), Ut, t[Ut]), Ft, t[Ft]),
                    a()(a()(a()(a()(a()(a()(a()(e, v, t[v]), zt, t[zt]), Kt, t[Kt]), Qt, t[Qt]), Xt, t[Xt]), Yt, t[Yt]), "ts", Date.now())))
                }).catch(function(t) {
                    n.logError(t)
                })
            }
            ...
            value: function(t) {
                ...
                return !("string" != typeof t || -1 === t.search(/^[a-zA-Z0-9-_.]+$/) || t.length < 3 || 100 < t.length) || (e = Si.failPattern,
                100 < (null == t ? void 0 : t.length) && (e = Si.failLength),
            ...
            value: function(t, e) {
                ...
                this._clientId = J(this._clientIdCookieName),
                ...
                w = n.inIframe,
                n = n.jsLibraries,
                _e("CLIENT_METADATA", E, b, S, I, i, r, o, a, u, s, c, l, f, d, h, p, v, g, _, y, m, w, void 0 === n ? [] : n))),
                O && this.identify(O),
            ...
            value: function(t) {
                ...
                var e, n = yi(this._identifierAttributes);
                try {
                    for (n.s(); !(e = n.n()).done; ) {
                        var i = e.value
                          , r = t.getAttribute(i);
                        if (r)
                            return "[".concat(i, '="').concat(Ve()(r, {
                                isIdentifier: !0
                            }), '"]')
                    }
                } catch (t) {
                ...
                return this._targetAll ? Xe(t, this._finderOptions) : ""
            }
        }, {
            key: "registerTarget",
            value: function(t, e) {
                ...
                var i, r, o, a, u, s, c, l, f, d = Re(t), h = this._generateAndTruncateSaltedHash(d), p = t.attributes, v = [];
            ...
            key: "getClientId",
            value: function() {
                return J(this._clientIdCookieName)
            }
        }, {
            key: "setUserId",
            value: function(t) {
            ...
            value: function() {
                var t = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : null;
                this._isValidId(t, "ATTEMPTED_REGISTERED_USER_ID") || (t = "scrubbed-id-failed-validation"),
            ...
            value: function() {
                ...
                String.fromCharCode.apply(String, M()(t))) : $(),
                sessionStorage.setItem(this._saltStorageName, t)
            }
        }, {
            key: "_generateAndTruncateSaltedHash",
            value: function(t) {
                var e;
                return "string" == typeof t && 0 < t.length ? (sessionStorage.getItem(this._saltStorageName) || this._createSaltAndSave(),
                e = sessionStorage.getItem(this._saltStorageName),
                ln()(t + e).toString().substring(0, 8)) : ""
            }
        }, {
            key: "sendData",
            value: function() {
            ...
            value: function(t) {
                ...
                t && t instanceof Array && t.forEach(function(e) {
                    ...
                    e.on("blur", function() {
                        ...
                        0 <= (null == (t = e.container) || null == (t = t.className) ? void 0 : t.indexOf("invalid")) && n._queueSimpleEvent(e.name, at)
                    }),
                    e.on("cut", function() {
    ...
    function xi() {
        ...
        if ("function" == typeof t[0])
            ...
            try {
                e.call.apply(e, [L].concat(M()(n)))
            } catch (t) {
                L.logError(t, "nid")
            }
        }
        window.nid.q.length && xi()
    }
    null != (R = window.nid) && R.version ? (console.warn("Attempting to load multiple nid libraries."),
    ...
    ,
    g()(Ii).forEach(function(t) {
        window.nid[t] = Ii[t].bind(L)
    }),
    window.nid.q.length && xi()) : console.error("No nid.js configuration found")
}
]);
//# sourceMappingURL=nid-adv-5.2.4-1912-578cdf8.js.map
